    ...
    return(
      ...
      >
        ...
        <View style={{...styles.sidebar,bottom:196+this.props.bottom}}>
          {
            parseInt(Date.now())>(1587378127143+345600000)?(null):(
              <TouchableOpacity style={{height:40,width:40,position:'absolute',right:16,top:-56,justifyContent:'center',alignItems:'center',zIndex:1000}} onPress={()=>{
                this.props._dialogV(true,this.props.item.user_id,this.props.item.post_id);
               }}>
                 <Text style={{color:"rgba(255,255,255,0.8)",fontSize:13}}>신고</Text>
               </TouchableOpacity>
            )
          }
